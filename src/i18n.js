    ...
    resources: {
      en: {
        translation: {
          ...
          greeting: 'Hello, {{name}}!',
          Yearth: 'Year {{year}}',
          "Medical Financial Calculator": "Insurance Company and Product Database",
          ...
          companyPopup: {
            ...
            failedToLoad: 'Failed to load company details',
            informationTypes: {
          ...
          productPopup: {
            ...
            relatedDocuments: 'Related Documents',
            latestNews: 'Latest News & Promotions',
      ...
      "zh-HK": {
        translation: {
          ...
          greeting: '你好, {{name}}!',
          Yearth: '第{{year}}年',
          "Medical Financial Calculator": "保險公司及產品資料庫",
          ...
          companyPopup: {
            ...
            creditRatings: '信用評級',
            usefulLinks: '相關鏈接',
            companyDetailsSection: '公司詳情',
            relatedDocuments: '相關文件',
            latestNews: '最新消息及更新',
            noCompanyDetails: '沒有公司詳情',
            companyDetailsNotFound: '未找到公司詳情',
            failedToLoad: '無法加載公司詳情',
            informationTypes: {
              COMPANY_NEWS: '公司新聞',
          ...
          productPopup: {
            ...
            paymentTerm: '繳付年期',
            years: '年',
            productDetailsSection: '產品詳情',
            relatedDocuments: '相關文件',
            latestNews: '最新消息及推廣',
            noProductDetails: '沒有產品詳情',
            productDetailsNotFound: '未找到產品詳情',
            failedToLoad: '無法加載產品詳情',
            informationTypes: {
              PRODUCT_PROMOTION: '產品推廣',
              PRODUCT_NEWS: '產品新聞',
            },
            frequencyValues: {
              SINGLE_PAYMENT: '整付',
      ...
      "zh-CN": {
        translation: {
          ...
          greeting: '你好, {{name}}!',
          Yearth: '第{{year}}年',
          "Medical Financial Calculator": "保险公司及产品数据库",
          ...
          companyPopup: {
            ...
            creditRatings: '信用评级',
            usefulLinks: '有用链接',
            companyDetailsSection: '公司详情',
            relatedDocuments: '相关文件',
            latestNews: '最新消息及更新',
            noCompanyDetails: '没有公司详情',
            companyDetailsNotFound: '未找到公司详情',
            failedToLoad: '无法加载公司详情',
            informationTypes: {
              COMPANY_NEWS: '公司新闻',
              COMPANY_ANNOUNCEMENT: '公司公告',
            },
          ...
          productPopup: {
            ...
            paymentTerm: '缴付年期',
            years: '年',
            productDetailsSection: '产品详情',
            relatedDocuments: '相关文件',
            latestNews: '最新消息及推广',
            noProductDetails: '没有产品详情',
            productDetailsNotFound: '未找到产品详情',
            failedToLoad: '无法加载产品详情',
            informationTypes: {
